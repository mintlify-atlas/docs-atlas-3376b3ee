...
<Steps>
  ...
  <Step title="Add dependencies">
    ...
    ```bash
    npm install tailwind-variants clsx tailwind-merge tw-animate-css
    ```
  </Step>

  <Step title="Add icon library">
  ...
  <Step title="Import styles to your app">
