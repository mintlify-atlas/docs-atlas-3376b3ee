...
Choose your framework to get started with shadcn-svelte:

<CardGroup cols={2}>
  <Card title="SvelteKit" icon="svelte" href="/installation/sveltekit">
  ...
  <Card title="Manual" icon="wrench" href="/installation/manual">
