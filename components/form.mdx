...
- Enables you to easily use various components like [Select](/components/select), [RadioGroup](/components/radio-group), [Switch](/components/switch), [Checkbox](/components/checkbox) and other form components with forms.
...
<Steps>
  <Step title="Create a form schema">
  ...
  <Step title="Setup the load function">
  ...
  <Step title="Create form component">
    ...
    ```svelte title="src/routes/settings/settings-form.svelte"
    <script lang="ts">
